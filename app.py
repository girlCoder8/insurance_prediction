...
def main():
    ...
    if flask.request.method == 'POST':
        ...
        input_variables = pd.DataFrame([[age, sex, bmi, children, smoker, region]],
                                       columns=['age', 'sex', 'bmi', 'children', 'smoker', 'region'], dtype=float,
                                       index=['input'])
        ...
        return flask.render_templates('main.html',
                                      original_input={'Age': age, 'Sex': sex, 'BMI': bmi, 'Children': children,
                                                      'Smoker': smoker, 'Region': region}, result=prediction, )
